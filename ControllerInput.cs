...
public class ControllerInput
{
    ...
    // Use this to autodetect COM Port for a given deviceID
    public void AutoDetect()
    {
        List<ManagementObject> lsMObj = new List<ManagementObject>(); //requires System.Management
        string[] sPortNames = SerialPort.GetPortNames(); // get real serial ports
        string sQuery = "SELECT * FROM Win32_PnPEntity " +
                        "WHERE ConfigManagerErrorCode = 0"; // list of working devices 
